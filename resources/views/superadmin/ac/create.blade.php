...
<x-app-layout>
    ...
    <div class="container-fluid card-body border-none border-top border-5 border-success-subtle d-flex justify-content-center rounded-0 bg-light">
        <form action="{{route('ac.store')}}" method="post" class="w-100" enctype="multipart/form-data">
            @csrf
            <div class="container-fluid row d-flex justify-content-start mx-auto w-100 py-2">
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control" name="nama_ac" id="nama_ac" value="{{old('nama_ac')}}"
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="date" class="form-control" name="tgl_pemasangan" id="tgl_pemasangan" value="{{old('tgl_pemasangan')}}"
                    ...
                    <select name="ruangan_id" id="select2" class="form-select" required style="width: 100%">
                        ...
                        @else
                            ...
                            @foreach ($ruangan as $ruang)
                                <option value="{{$ruang->id}}">PLANT {{$ruang->plant}} - {{$ruang->nama_ruang}}</option>
                            @endforeach
                        @endif
                    </select>
                </div>
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" name="pk" id="pk" value="{{old('pk')}}" placeholder="Masukkan PK AC"
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <textarea name="spesifikasi" class="form-control" id="spesifikasi" required
                        placeholder="Masukkan Spesifikasi AC">{{old('spesifikasi')}}</textarea>
                </div>
                <div class="col-md-6 mb-3">
                    ...
                    <textarea name="tempat_beli" class="form-control" id="spesifikasi"
                        placeholder="Masukkan Tempat Beli AC">{{old('tempat_beli')}}</textarea>
                </div>
                <div class="col-md-6 mb-3">
                ...
                <button type="submit" class="col-md-12 btn btn-success">Simpan AC </button>
            </div>
        </form>
    </div>
</x-app-layout>