<x-app-layout title="Detail Pengajuan">
    <div class="container-fluid d-flex py-2 justify-content-between align-items-center">
        <h2 class="fw-bold">Detail Perbaikan <span class="badge text-bg-warning">{{$proses->ac->kode_inv}}</span></h2>
        <a href="{{route('proses.index')}}" class="btn btn-primary"><i class="fa-solid fa-arrow-left"></i>
            Kembali</a>
    </div>
    <div class="container-fluid card-body border-none border-top border-5 border-info shadow p-3 bg-light">
        <table class="table">
            <tr>
                <td width="20%">Tgl Pengajuan</td>
                <td width="2%">:</td>
                <td class="fw-bold">{{\Carbon\Carbon::parse($proses->tgl_pengajuan)->isoFormat('DD MMMM YYYY')}}</td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td>:</td>
                <td class="fw-bold">{{$proses->permasalahan}}</td>
            </tr>
            <tr>
                <td width="20%">Indikasi</td>
                <td>:</td>
                <td class="fw-bold">{{$proses->indikasi}}</td>
            </tr>
            <tr>
            ...
            <div class="col-md-4 mb-3">
                <div class="card-body border-none border-top border-5 border-secondary shadow p-2">
                    ...
                    <div class="container py-3 d-flex justify-content-center align-items-center">
                        ...
                        @else
                            <img src="{{asset('/storage/image/perbaikan/' . $proses->foto_petugas)}}" alt="foto_petugas"
                                class="w-75">
                        @endif
                    </div>
                </div>
            ...
            <div class="col-md-4 mb-3">
                <div class="card-body border-none border-top border-5 border-secondary shadow p-2">
                    <div class="container d-flex justify-content-between align-items-center">
                        ...
                        @if ($proses->foto_perbaikan !== null)
                            <a href="#fotoperbaikan" data-bs-toggle="modal" class="text-decoration-none"><i
                                    class="fa-regular fa-pen-to-square"></i></a>
                        @endif
                    </div>
                    <hr class="my-0">
                    <div class="container py-3 d-flex justify-content-center align-items-center">
                        @if ($proses->foto_perbaikan == null)
                            <a href="#fotoperbaikan" data-bs-toggle="modal" class="btn btn-secondary">Upload Foto</a>
                        @else
                            <img src="{{asset('/storage/image/perbaikan/' . $proses->foto_perbaikan)}}" alt="foto_perbaikan"
                                class="w-75">
                        @endif
                    </div>
                </div>
            ...
            <div class="col-md-4 mb-3">
                <div class="card-body border-none border-top border-5 border-secondary shadow p-2">
                    ...
                    <div class="container py-3 d-flex justify-content-center align-items-center">
                        ...
                        @else
                            <img src="{{asset('/storage/image/perbaikan/' . $proses->foto_pemeriksa)}}" alt="foto_pemeriksa"
                                class="w-75">
                        @endif
                    </div>
                </div>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{route('proses.foto', $proses->id)}}" method="post" enctype="multipart/form-data">
                        @csrf
    ...
    {{-- Foto Perbaikan --}}
    <div id="fotoperbaikan" class="modal fade">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="fw-bold">Upload Foto Perbaikan</h4>
                    <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                </div>
                <div class="modal-body">
                    <form action="{{route('proses.foto', $proses->id)}}" method="post" enctype="multipart/form-data">
    ...
    <div class="modal fade" id="selesai">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="fw-bold">Selesaikan Perbaikan</h4>
                    <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                </div>
                <form action="{{route('perbaikan.selesai', $proses->id)}}" method="post">
                    @csrf
                    <div class="modal-body">
