            ...
            <div class="row col-md-6">
                <form action="{{route('vendor.update', $vendor->id)}}" method="post">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="alamat" class="form-control" id="alamat" required>{{$vendor->alamat}}</textarea>
                    </div>
                    <div class="mb-3">
                        <label for="phone" class="form-label">Telepon</label>
                        <input type="number" class="form-control" min="0" name="phone" id="phone" value="{{$vendor->phone}}">
                    </div>
